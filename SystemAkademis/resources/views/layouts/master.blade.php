  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="{{env('URL_HOME')}}" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{{ url('../images/user.png') }}" alt="">{{ $biodata->nama }}
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            <div class="col-md-3 col-sm-6 col-xs-8 tile_stats_count">
              ...
              <div class="count" style="font-size:200%;">{{ $biodata->nama }}</div>

            </div>
            <div class="col-md-2 col-sm-6 col-xs-8 tile_stats_count">
              <span class="count_top"><i class="fa fa-clock-o"></i> NIM</span>
              <div class="count" style="font-size:200%;">{{ $biodata->nim }}</div>

            </div>
            <div class="col-md-5 col-sm-2 col-xs-2 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> Program Studi</span>
              <div class="count green" style="font-size:200%;">{{ $biodata->program_studi }}</div>

            </div>
            <div class="col-md-2 col-sm-2 col-xs-2 tile_stats_count">
              <span class="count_top"><i class="fa fa-user"></i> IPK</span>
              <div class="count" style="font-size:200%;">6.0</div>
        ...
        <!-- footer content -->
        {{-- FOOTER ERROR UNLIMITED SCROLLING --}}
        {{-- <footer>
